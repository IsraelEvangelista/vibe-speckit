...
## Instruções
Este workflow define o padrão para implementar cabeçalhos "sticky" que empilham múltiplos elementos (ex: filtros + cabeçalho de tabela) e ficam fixos no topo da área de rolagem, garantindo que não haja "gaps" (espaços vazados) onde o conteúdo passa por trás.
